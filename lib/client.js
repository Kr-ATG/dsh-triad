...
function CountBadge({ value, inline = false }) {
  const cls = [
    css.navCount,
    css.navCountPop,
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("span", { className: cls, title: value.toLocaleString(), children: formatCount(value) });
}
  ...
  const navItem = (key, icon, label, count) => /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)(
    "button",
    {
      ...
      children: [
        ...
        label,
        /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(CountBadge, { value: count }, count)
      ]
    },
    key
  );
                ...
                /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)(
                  "button",
                  {
                    ...
                    children: [
                      ...
                      t("navGlobal"),
                      /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(CountBadge, { value: summary?.globalCount ?? 0 }, summary?.globalCount ?? 0)
                    ]
                  }
                ),
