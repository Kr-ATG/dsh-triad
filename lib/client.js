...
function MemoryToggle({ sessionId, t, ...api }) {
  ...
  const hideTimer = (0, import_react12.useRef)(null);
  const [state, setState] = (0, import_react12.useState)({ enabled: true, defaultEnabled: true, explicit: false });
  const [open, setOpen] = (0, import_react12.useState)(false);
  const [pinned, setPinned] = (0, import_react12.useState)(false);
  const pinnedRef = (0, import_react12.useRef)(false);
  ...
  const showCard = (0, import_react12.useCallback)(() => {
  ...
  const scheduleCardHide = (0, import_react12.useCallback)(() => {
  ...
  const togglePin = (0, import_react12.useCallback)(() => {
    setPinned((prev) => {
      if (prev) {
        setOpen(false);
        return false;
  ...
  return (
    ...
    /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)("div", { ref: wrapRef, className: css.toggleWrap, onMouseEnter: showCard, onMouseLeave: scheduleCardHide, children: [
      open ? button : /* @__PURE__ */ (0, import_jsx_runtime9.jsx)(import_dsh_client_ui_primitives4.Tooltip, { label: isOn ? t("injectOn") : t("injectOff"), side: "top", delayMs: 500, children: button }),
