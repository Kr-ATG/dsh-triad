...
/** 自动化面板（含侧边栏入口按钮，经 triad 导航 automation 槽位挂载）。 */
export function AutomationApp({ ctx }: { ctx: ClientContext }): JSX.Element | null {
  ...
  // 与用量/能力/记忆面板互斥 + 切会话自动收（triad 导航统一行为）。
  usePanelAutoClose('automation', open, close)
